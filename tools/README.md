...
Addresses are file offsets in the thin armv7 slice (fat offset `0x1000` inside
`game/sixsense`), which is what every address in the port's comments and in `docs/`
refers to.
