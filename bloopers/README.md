...
- `game/sounds/unused/bloopers/stop_standing_by_the_zombie!.ogg`, 39 seconds, 2026-09-22. The girl asks for help as she normally does, but "headshot!" rings out from right beside her, from the zombie standing next to her. Why bother asking for help when you are standing right next to the zombie? For a while the headshot announcement was converted to mono so it would pan, which put it at the zombie's position instead of in the centre, where the original always has it. It is centred again.
