...
- [Safe test run](project_safe_test_run.md): the tests write the real save and play audio. Redirect APPDATA and use `ALSOFT_DRIVERS=null`. The tests are plain scripts. Baseline 96/96; now 178/178 across 13 files (2026-09-22, after the zombie batch), in about 87 s.
