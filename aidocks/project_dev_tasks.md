...
- Check that the tests pass after the second sound sort. Since the lookup searches game/sounds/unused last, data.py and pause.py pass as they are; the rest of the suite has not been run since.
