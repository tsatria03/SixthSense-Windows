...
- From the 2026-09-24 binary recheck: the walk never sets walkXFlag for its 0.6 seconds; DIVERGENCES.md's Input section still says shaking free takes 10 presses; and the DIVERGENCES and PORTING_STATUS lines behind the nine new todo items (shots heard down their lane, the coin row's 2 s and 1 s) are misreadings to correct with those fixes.
