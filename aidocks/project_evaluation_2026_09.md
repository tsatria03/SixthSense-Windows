...
6. **A zombie's hit and the girl's thank-you come from the centre.** `hitPlayer` plays at (0, 0), z 40, gain 1.0 (0x11f92..0x11fa2). Port: `monster_control.py:439-440` plays at the monster's position.
