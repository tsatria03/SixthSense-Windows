...
7. **The empty click (78).** The original clears `shotFlag` at once and plays down the aimed lane at z 40 (0x2fcee -> 0x2fdc2; grenade 0x2f508). Port: (0, 0), z 0, and it blocks the next shot for `ShotTime` (`stage_1_e.py:857-861`, 899-903).
