...
9. **Two missing clicks (10).** The Store row: `Store:` (0xb67c) clicks at 0xb6a8 before `StoreAction:`; port `main_controller.py:276-283` plays nothing. Start Game with no coin: `StartGame:` clicks at 0xad32 before 358; port clicks only when a coin is spent (`main_controller.py:295`).
