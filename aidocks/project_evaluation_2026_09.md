...
8. **Coin row timing.** "After" -> minutes 1.3 s, not 2.0 (0x5e62..0x5e82); "minutes" -> seconds 0.8 s, not 1.0 (0x5dbc..0x5dd6); the count 1.6 s after "number of coins", not 1.5 (0x9bec..0x9c0c). Port: `app_delegate.py:274`, `:282`, `main_controller.py:225`. The DIVERGENCES line with 2 s and 1 s repeats the misreading.
